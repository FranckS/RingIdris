...
-- Normalize expression reflecting an element of a magma
-------------------------------------------------------------------
...
magmaReduce (PlusMa e1 e2) = let (r_ih1 ** (e_ih1, p_ih1)) = (magmaReduce e1) in
...
exprMa_eq p (ConstMa p const1) (ConstMa p const2) with ((Magma_getSet_eq p) const1 const2)
...
magmaDecideEq p e1 e2 = let (r_e1 ** (e_e1, p_e1)) = magmaReduce e1 in
