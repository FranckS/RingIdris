...
any equivalence relation. The user is free to define the equivalence relation of their choice, but it should be compatible with the operations that he is using.
