...
\begin{itemize}
	...
	\item Present a way to test the predicate in the proof assistant, by automatically generating terms, and we automate these tests as far as possible (section~\ref{sect:testingInside})
