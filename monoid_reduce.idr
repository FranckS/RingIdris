...
elimZero c p (PlusMo (ConstMo p const1) (VarMo p v)) with (monoid_eq_as_elem_of_set p Zero const1)
...
elimZero c p (PlusMo (VarMo p v) (ConstMo p const2)) with (monoid_eq_as_elem_of_set p Zero const2) 
